...
# La transformaci?n no ayud?, as? que le aplicamos diferencia.
...
pacf(Yt_t_1r,lag.max=39,
     ...
     main="PACF de la serie .......",
     ylab="Autocorrelaciones parciales",
     xlab="Retardo")  # lag.max = length(Yt)/4
# AR
# (1,1,1)(2,0,1)[]
...
# (1,1,0)(1,0,0) R
# (1,1,1)(2,0,1) Javier
# (2,1,1)(1,0,0) Giulliana
# Calcular las sumatorias, Akaike, EMAPE, etc.. En resumen, validar los modelos.